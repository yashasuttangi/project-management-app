...
const TabButton = ({ name, icon, setActiveTab, activeTab }: TabButtonProps) => {
  ...
  return (
    <button
      className={`relative flex items-center gap-2 px-1 py-2 text-gray-500 after:absolute after:-bottom-[9px] after:left-0 after:h-px after:w-full hover:text-blue-600 sm:px-2 lg:px-4 dark:text-neutral-500 dark:hover:text-white cursor-pointer ${
